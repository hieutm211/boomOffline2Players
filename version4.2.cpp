...
void removeBlocksInBombLine(const vector<tBomb>& bomb, const int& lastExplodedPosition) {
...
void removeItemsInBombLine(const vector<tBomb>& bomb, const int& lastExplodedPosition) {
	vector<vector<bool>> mark(map.row, vector<bool>(map.col, false));
...
void removeExplodedBomb(vector<tBomb>& bomb) {
	...
	removeItemsInBombLine(bomb, newBegin);
